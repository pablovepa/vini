...
public class SignUp extends javax.swing.JFrame {
   ...
   String Nombresis,Autor,Web,Email,Telefono;
    String usuarios;   
    String tipos_usuarios;
    ArrayList<usuarios> estructura_usuarios=new ArrayList<usuarios>();
    ArrayList<SignUp> estructura_tipos=new ArrayList<SignUp>();
...
//=== metodos    
 public void Agregar_usuario(){
      usuarios s = new usuarios("","","","","");
        ...
        s.setClave(this.jPasswordField1.getText());
 ...
 public void LeerDatos_tipo_usuario(){
          try {
             File archivo = new File(tipos_usuarios);  
            FileInputStream fin= new FileInputStream (archivo.getAbsolutePath());  
            ObjectInputStream ois = new ObjectInputStream(fin);
            estructura_tipos = (ArrayList<SignUp>)ois.readObject();
            fin.close();
        } catch(Exception ex) {
            ex.printStackTrace();
        }
  ...
  //public void mostrarDatos_combo_tipos(){
        // this.jComboBox1.removeAllItems();
         
        // for (int i=0;i<estructura_tipos.size();i++) {        
         /// this.jComboBox1.addItem(estructura_tipos.get(i).getNombre());
           // } 
     //}
    ...
    //ArrayList<tipos_usuarios> estructura_tiposusuarios=new ArrayList<tipos_usuarios>();  
